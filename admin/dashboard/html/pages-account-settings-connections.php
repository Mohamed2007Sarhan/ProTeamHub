...
<head>
  ...
  <title>Notivication & News - Pages | ProTeamHub</title>
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4">
              <span class="text-muted fw-light">Notivication & News / </span> News
            </h4>
            ...
            <div class="row">
              <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="pages-account-settings-notifications.php"><i class="bx bx-bell me-1"></i> Notifications</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" href="javascript:void(0);"><i class="bx bx-link-alt me-1"></i> News</a>
                  </li>
                </ul>
                <div class="row">
                  ...
                  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                    ...
                    $sql = "INSERT INTO news (user_id, username, `new`, img, `like`, img_user) 
            VALUES ('$user_id', '$username', '$new', '$img', '$like', '$img_user')";
                  ...
                  <body>
                    ...
                    <div class="container">
                          ...
                          <?php if ($result->num_rows > 0) : ?>
                            <?php while ($row = $result->fetch_assoc()) : ?>
                              <tr>
                                ...
                                <td><?= $row['img'] ?></td>
                                <td><?= $row['like'] ?></td>
                                <td><img src="<?= $row['img_user'] ?>" alt="User Image" width="50" height="50"></td>
                                <td>
                                  <!-- Delete button -->
                      ...
                      <!-- Add new news button -->
                      <button class="btn btn-add" onclick="document.getElementById('addNewsForm').style.display='block'">Add New News</button>
                      ...
                      <div id="addNewsForm" style="display:none;">
                        ...
                        <form method="POST" action="">
                          ...
                          <input type="text" id="new" name="new" required><br><br>
                          ...
                          <label for="img_user">User Image URL:</label>
                          <input type="text" id="img_user" name="img_user" required><br><br>
