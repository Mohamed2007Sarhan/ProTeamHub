...
>
  <head>
    ...
    <title>Vertical Accounts - Forms | ProTeamHub</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Vertical Accounts</h4>
                    ...
                    <div class="card-body">
                      <form>
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="<?= htmlspecialchars($_SESSION['username']) ?> " />
                        </div>
                        <div class="mb-3">
