...
>
  <head>
    ...
    <title>Horizontal Accounts - Forms | ProTeamHub</title>
        ...
        <div class="layout-page">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item lh-1 me-3">
                  <a
                    ...
                    aria-label="Star ProTeamHub/ProTeamHub-html-admin-template-free on GitHub"
                    >Star</a
                  >
                </li>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Horizontal Accounts</h4>
                    ...
                    <div class="card-body">
                      <form>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-name" placeholder="<?= htmlspecialchars($_SESSION['username']) ?> " />
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <input
                                ...
                                class="form-control"
                                placeholder="<?= $_SESSION['username'] ?>.doe"
                                aria-label="<?= $_SESSION['username'] ?>.doe"
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <input
                                ...
                                aria-label="<?= htmlspecialchars($_SESSION['username']) ?> "
