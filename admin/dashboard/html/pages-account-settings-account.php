...
>
  <head>
    ...
    <title>Notivication & News - Account | ProTeamHub</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Notivication & News /</span> Account</h4>
                  ...
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="pages-account-settings-connections.php"
                        ><i class="bx bx-link-alt me-1"></i> News</a
                      >
                    </li>
                  </ul>
                  <div class="card mb-4">
                        ...
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input
                              ...
                              id="email"
                              name="email"
                              value="<?= $_SESSION['username'] ?>.doe@example.com"
                              placeholder="<?= $_SESSION['username'] ?>.doe@example.com"
                            />
                          </div>
                          <div class="mb-3 col-md-6">
