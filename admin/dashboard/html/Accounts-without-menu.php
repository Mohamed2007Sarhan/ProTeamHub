...
<head>
  ...
  <title>Accounts Edit - Accounts | ProTeamHub</title>
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="layout-demo-wrapper">
              <div class="layout-demo-placeholder">
                <img
                  src="../assets/img/Accounts/layout-without-menu-light.png"
                  class="img-fluid"
                  alt="Layout Accounts Edit"
                  data-app-light-img="Accounts/layout-without-menu-light.png"
                  data-app-dark-img="Accounts/layout-without-menu-dark.png" />
              </div>
              <div class="layout-demo-info">
                <h4>Accounts Edit (Navigation)</h4>
                <!DOCTYPE html>
                <html lang="en">
                <style>
                  /* General Styles */
                    ...
                    <div class="container">
                      ...
                      <form id="editUserForm">
                        <div class="form-group">
                          ...
                          <input type="text" id="userId" placeholder="User ID" required name="id_user">
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <select id="accountType" required name="accountType">
                            <option value="organizer">organizer</option>
                            <option value="expert">expert</option>
                            <option value="members">members</option>
                            <option value="team_founders">team_founders</option>
                          </select>
                        </div>

                        <div class="form-group">
                          <label for="isActive">Account Status:</label>
                          <select id="isActive" required name="active">
                        ...
                        <div class="form-group">
                          ...
                          <input type="password" id="password" placeholder="Enter password (optional)" name="password">
                        </div>
