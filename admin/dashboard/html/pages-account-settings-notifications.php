        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4">
              <span class="text-muted fw-light">Notivication & News /</span> Notifications
            </h4>
            ...
            <div class="row">
              <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="pages-account-settings-connections.php"><i class="bx bx-link-alt me-1"></i> News</a>
                  </li>
                </ul>
                <div class="card">
                  <!-- Notifications -->
                  ...
                  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                    ...
                    $sql = "INSERT INTO notviation (user_id, `from`, Description, img, active) 
            VALUES ('$user_id', '$from', '$description', '$img', '$active')";
                  ...
                  if (isset($_GET['delete_id'])) {
                    ...
                    $sql = "DELETE FROM notviation WHERE id=$id";
                    if ($conx->query($sql) === TRUE) {
                  ...
                  // Fetch data from notifications table
                  $sql = "SELECT * FROM notviation";
                  ...
                  <head>
                    ...
                    <title>Notifications Display</title>
                    <style>
                      body {
                  ...
                  <body>
                    ...
                    <div class="container">
                          ...
                          <?php if ($result->num_rows > 0) : ?>
                            <?php while ($row = $result->fetch_assoc()) : ?>
                              <tr>
                                ...
                                <td><img src="<?= $row['img'] ?>" alt="Image" width="50" height="50"></td>
                      ...
                      <button class="btn btn-add" onclick="document.getElementById('addNotificationForm').style.display='block'">Add New Notification</button>
