...
if (isset($_GET['Verification'])) {
  ...
  if (mysqli_num_rows($raquet) > 0) {
    ...
    if ($query) {
      ...
      header("Location: ../web/dashboard1.php?id='{$rowv['id']}'");
    } else {
...
if (isset($_POST['submit'])) {
  ...
  $Pass = mysqli_real_escape_string($conx, encryptData($_POST['Password']));
...
<head>
  ...
  <title>Sign in - ProTeamHub</title>
  <style>
    .alert {
      padding: 1rem;
      border-radius: 5px;
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        <div class="content">
          <h3>New here ?</h3>
          <p>
            Welcome back to ProTeamHub – Ready to continue your journey with us?
          </p>
